...
void PrintWinStreak(const Player& aPlayer)
{
...
void UpdateWinStreak(bool aIsWin, Player& aPlayer)
{
...
void UpdateMoneyTable(int aBet, const Casino::GameState& aGameState, const bool aIsWin, Player& aPlayer,
...
void BeginGameLogic(Casino::GameState& aGameState, Player& aPlayer, TableGuess::Data& aGuess, TableOddEven::Data& aOddEven,
...
void EnterTableMenu(Casino::GameState aGameState, Player& aPlayer, Casino& aCasino, TableGuess::Data& aGuess,
...
void MainMenu(Casino::GameState aGameState, Player::Data& aPlayer, Casino& aCasino)
{
...
int main()
{
    ...
    while (casino.isMainActive && AmIPoor(player) == false)
    {
        SayMainMenuChoices();
        MainMenu(static_cast<Casino::GameState>(Casino::InputInt()), player, casino);
    }
    SayByeCasino(player);
};
